        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST">
                    ...
                    <h1 class="mb-5 text-center">Edit Jadwal</h1>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="route" name="route"
                            ...
                            placeholder="Contoh: Jakarta - Surabaya" value="{{ old('route', $schedule->route) }}"
                            required>
                        @error('route')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" id="departure_date" name="departure_date"
                                ...
                                value="{{ old('departure_date', $schedule->departure_date->toDateString()) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="total_seats" name="total_seats"
                            ...
                            value="{{ old('total_seats', $schedule->total_seats) }}" min="1" required>
                        @error('total_seats')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="price" name="price"
                            ...
                            step="0.01" value="{{ old('price', $schedule->price) }}" required>
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="driver_name" name="driver_name"
                            ...
                            value="{{ old('driver_name', $schedule->driver_name) }}">
                        @error('driver_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="vehicle_number" name="vehicle_number"
                            ...
                            value="{{ old('vehicle_number', $schedule->vehicle_number) }}">
